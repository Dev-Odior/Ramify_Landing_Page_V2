...
import { ShieldCheck, Users, Truck, Package, Lock, Building2, Wallet, UserPlus, ShoppingBag, HeartPulse, CreditCard, TrendingDown, CalendarClock, MapPin } from 'lucide-react';
import { NavItem, ValueProp, Step, Feature, PricingTier, Addon, Testimonial, FAQCategory, FooterSection, ModalContent } from './types';
...
export const HOW_IT_WORKS_STEPS: Step[] = [
    {
        ...
        description: 'Sign up as an Individual, Business, or Ajo/Group Admin. Onboarding takes less than 2 minutes.',
        icon: UserPlus
    },
    {
        title: 'Choose What You Want',
        description: 'Select Small, Medium, or Large rams. Choose between Live Ram or Meat Pack options.',
        icon: ShoppingBag
    },
    {
        title: 'Choose How to Pay',
        description: 'One-time payment or flexible savings (Daily/Weekly/Monthly) via Moniepoint virtual account.',
        icon: CreditCard
    },
    {
    ...
    },
    {
        ...
        description: 'Receive live ram or meat pack at your doorstep with insured transit and tracking.',
        icon: Truck
    }
];
...
export const FEATURES_GRID: Feature[] = [
    ...
    },
    {
        ...
        icon: Lock,
        items: [
            'Virtual account via Moniepoint',
            'Instant settlements',
...
export const PRICING_TIERS: PricingTier[] = [
    {
        ...
        features: ['Procurement included', 'Goods-in-Transit Insurance', 'Vet Health Check', 'Feeding & Care']
    },
    {
        name: 'Medium Ram',
        price: '₦ 270,000',
        ...
        highlight: true,
        features: ['Procurement included', 'Goods-in-Transit Insurance', 'Vet Health Check', 'Feeding & Care', 'Most Popular Choice']
    },
    {
        name: 'Large Ram',
        price: '₦ 410,000',
...
export const TESTIMONIALS: Testimonial[] = [
    {
        ...
        content: 'Last year, Sallah ram prices doubled a week before. With Ramify, I had locked down my price months ago. The ram was delivered healthy and on time.',
        avatar: 'https://picsum.photos/100/100?random=1'
    },
    {
        name: 'TechPoint Solutions',
        role: 'Business Account',
        content: 'We used Ramify to distribute meat packs to our 50 staff members. The CSV upload feature made it incredibly easy. Highly recommended for corporate gifting.',
        avatar: 'https://picsum.photos/100/100?random=2'
    },
    {
        name: 'Market Women Union',
        role: 'Ajo Group Lead',
        content: 'Our Ajo group saved together. The transparency was key; everyone could see the progress. We got 10 large rams delivered without stress.',
...
export const FAQ_CATEGORIES: FAQCategory[] = [
    ...
    },
    {
        category: 'Delivery',
        items: [
            { question: 'How does delivery work?', answer: 'We offer doorstep delivery during specific festival windows.' },
            { question: 'Can I choose my delivery date?', answer: 'No — we deliver according to routes and locations to deliver efficiently and accordingly.' },
            { question: 'What if I am not available?', answer: 'Our rider will call. A second attempt may require a small re-delivery fee.' }
        ]
    },
    {
        category: 'Meat Packs',
        items: [
            { question: 'How does meat splitting work?', answer: 'You choose equal or custom split options, with packaging included.' },
            { question: 'Can I send packs to multiple addresses?', answer: 'Yes — add addresses manually or upload a CSV file.' }
        ]
    },
    {
        category: 'Business & Ajo',
        items: [
            { question: 'Can businesses buy in bulk?', answer: 'Yes — with multiple delivery addresses and custom branding options.' },
            { question: 'How do Ajo groups work?', answer: 'Group leader sets rules; members contribute until the full amount is met.' }
        ]
    },
    {
        category: 'Quality & Insurance',
        items: [
            { question: 'Are the rams checked?', answer: 'Yes — full vet inspection and feeding program is included.' },
            { question: 'Is delivery insured?', answer: 'Yes — Goods-in-transit insurance covers accidents, loss, or death.' }
        ]
    },
    {
        category: 'General Questions',
        items: [
            { question: 'When does Ramify open for savings?', answer: 'Ramify opens for savings Early 2026.' }
        ]
    }
];
